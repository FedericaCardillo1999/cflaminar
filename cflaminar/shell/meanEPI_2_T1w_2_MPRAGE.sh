...
base_directory="/Volumes/FedericaCardillo/pre-processing/projects/PROJECT_EGRET-AAA/${subj}"
coreg_directory="/Volumes/FedericaCardillo/pre-processing/projects/PROJECT_EGRET-AAA/derivatives/coreg/${subj}"
